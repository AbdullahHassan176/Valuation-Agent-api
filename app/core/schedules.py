...
from .models import BusinessDayConvention, Calendar, Frequency
...
def _convert_calendar(calendar: Calendar):
    ...
    from .schedules.calendar import Calendar as ScheduleCalendar
    
    # Simple mapping - in real implementation would use proper calendar conversion
    return ScheduleCalendar.WEEKENDS_ONLY
